  ...
  <div class="md-movie-item">
    <view class="md-movie-item__item">
      ...
      <view class="md-movie-item__meta">
        ...
        <text class="md-movie-item__sub-title">{{ movie.pubdate }} ({{ movie.publisher }})</text>
        <view class="md-movie-item__artists">作者：<block v-for="(director, i) in movie.author" :key="director.id"> {{ director }} </block></view>
      </view>
