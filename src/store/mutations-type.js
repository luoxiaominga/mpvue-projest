...
export const BOARD_BOOKS_LIST = 'BOARD_BOOKS_LIST' // 榜单书本列表
export const LIST_BOOKS_LIST = 'LIST_BOOKS_LIST' // 书本列表
export const ITEM_BOOKS_DETAIL = 'ITEM_BOOKS_DETAIL' // 书本详情
